...
### Added
* Usage stats, dependency list, related variables and file locations in documentation.

### Changed
* Completion and docs use last value per context to honor cascade.
* Improved context labels for complex media queries.
