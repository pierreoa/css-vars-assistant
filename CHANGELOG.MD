...
- Docs now display usage stats, dependency lists, related variables, and file locations.
...
- Completions and docs now use the last value per context (cascading logic).
